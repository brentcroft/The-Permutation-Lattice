...
- `(a,b)` means `"a lots of b"`: stride `a` along the primary axis, step `1` along the secondary, repeat. Place-value table: `|a|1|`.
- `(b,a)` means `"b lots of a"`: stride `b` along the primary, step `1` along the secondary, repeat. Place-value table: `|b|1|`.
